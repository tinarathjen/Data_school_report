...
```{r second_plot, echo=FALSE, fig.align='center', fig.height=4, fig.width=6, out.width='80%', cap.fig="Vernalisation effect on flowering time"}
...
ggplot()+
  geom_point(data=flw_hd_data_vern,mapping=aes(x=reorder(genotype, LN), y=LN,colour="#4daf4a"),size=1.5)+
  geom_point(data=flw_hd_data_vern,mapping=aes(x=reorder(genotype, LN),y=LV, colour="#377eb8"),size=1.5)+
  geom_label_repel(data=cult_sel,mapping=aes(x=reorder(genotype, LN),y=LV,  label=genotype), colour="black",
             size=2, angle=90, vjust=3)+
...
ggplot()+
    geom_point(data=flw_hd_data_pp,mapping=aes(x=reorder(genotype, SV), y=LV,colour="#377eb8"),size=1.5)+
    geom_point(data=flw_hd_data_pp,mapping=aes(x=reorder(genotype, SV),y=SV, colour="#e41a1c"),size=1.5)+
    geom_label_repel(data=cult_sel,mapping=aes(x=reorder(genotype, LN),y=LV,  label=genotype), colour="black",
             size=2, angle=90, vjust=3)+
...
```{r r fourth_plot, echo=FALSE, fig.align='center', fig.height=4, fig.width=6, out.width='80%', cap.fig="Vernalisation requirement and photoperiod sensitivity of wheat cultivars"}
#all varieties
...
cult_sel2 <- all_data_wide3 %>% 
  ...
  ggplot(data=all_data_wide3, mapping=aes(x=vern_effect, y=pp_effect, shape=Type, colour=Maturing, fill=Maturing))+
  geom_point()+
...
```{r standard-plot4, echo=FALSE, fig.align='center', fig.height=4, fig.width=6, out.width='80%', fig.cap ="Correlation of flowering time with the other traits"}
...
plot1 <- ggplot(all_data_wide, mapping=aes(x=half_fwr, y=fwr_MS))+
  ...
  labs(title="Relationship of flowering time on mainstem versus 50% flowering", x = "50% Flowering, degree-days", y = "Flowering MS, degree-days", size = 2)+
  theme_bw()+
...
plot2 <- ggplot(all_data_wide, mapping=aes(x=half_fwr, y=half_hd))+
  geom_point(alpha=0.4, colour="grey49")+
  geom_smooth(method=lm, colour="blue")+
  labs(title="Relationship of flowering time and heading time", x = "50% Flowering, degree-days", y = "Heading MS, degree-days", size = 2)+
  theme_bw()+
  theme(plot.title = element_text(size=6, hjust = 0.5),
        panel.grid.minor.x  = element_blank(),
        axis.title = element_text(size = 8),
...
plot3 <- all_data_wide %>% 
  ...
  geom_point(alpha=0.4, colour="grey49")+
  geom_smooth(method=lm, colour="blue")+
  labs(title="Relationship of flowering time versus spikelet number", x = "50% Flowering, degree-days", y = "Spikelet number", size = 2)+
  theme_bw()+
  theme(plot.title = element_text(size=6, hjust = 0.5),
        panel.grid.minor.x  = element_blank(),
        panel.grid.major.x  = element_blank(),
...
plot4 <- all_data_wide  %>%
  ...
  geom_point(alpha=0.4, colour="grey49")+
  geom_smooth(method=lm, colour="blue")+
  labs(title="Relationship of flowering time versus final leaf number", x = "50% Flowering, degree-days", y = "Final leaf number", size = 2)+
  theme_bw()+
  theme(plot.title = element_text(size=6, hjust = 0.5),
        panel.grid.minor.x  = element_blank(),
        axis.title = element_text(size = 8),
